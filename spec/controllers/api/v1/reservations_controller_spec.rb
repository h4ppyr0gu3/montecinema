...
RSpec.describe Api::V1::ReservationsController, type: :controller do
  ...
  describe 'GET #index' do
    let(:index_use_case) { instance_double(Reservations::UseCases::Index,
      call: {reservation: 'reservation'})
    }
    let(:index_representer) { instance_double(Reservations::Representers::Multiple,
  ...
  describe 'GET #show' do
    let(:show_representer) { instance_double(Reservations::Representers::Single,
      call: {reservation: 'reservation'})
    }
  ...
  describe 'POST #create' do
    let(:create_use_case) { instance_double(Reservations::UseCases::Create, 
      call: {reservation: 'reservation'})
    } 
    let(:single_representer) { instance_double(Reservations::Representers::Single,
  ...
  describe 'PUT #update' do
    let(:update_representer) { instance_double(Reservations::Representers::Single,
      call: {reservation: 'reservation'})
    }
    let(:update_use_case) { instance_double(Reservations::UseCases::Update,
      call: {res: 'updated'})
    }
    let(:update_request) { 
      put :update, params: { 
